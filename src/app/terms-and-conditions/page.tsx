  ...
  return (
    <div className="mx-auto max-w-[760px] px-4 py-14 sm:px-8">
      ...
      <Section title="2. पात्रता (Eligibility)">
        <p>सदस्यता के लिए आवेदक की आयु 18 से 40 वर्ष के बीच होनी चाहिए, तथा आवेदक को भारतीय जनता पार्टी एवं भारतीय जनता युवा मोर्चा की विचारधारा एवं नीतियों का समर्थक होना चाहिए।</p>
      </Section>
